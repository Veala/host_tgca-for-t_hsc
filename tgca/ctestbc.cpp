...
/// Число несовпавших битов добавляется к значению переменной num_wrong_bit.
/// Если число несовпавших битов не превышает max_wrong_bit, функция возвращает true.
...
/// num_b - размер данных для сравнения в байтах,
/// wrong_bit - число несовпавших битов,
/// max_wrong_bit - максимальное разрешенное число несовпавших битов.
/// Функция прекращает дальнейшее сравнение при превышении max_wrong_bit.
/// Если число несовпавших битов меньше или равно разрешенному, то в переменную wrong_bit
